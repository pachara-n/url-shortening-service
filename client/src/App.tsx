          ...
          <div className="relative group w-full max-w-2xl pt-4">
            ...
            >
              ...
              <button
                ...
                className="w-full sm:w-auto bg-gradient-to-br from-primary to-[#064e3b] text-on-primary px-8 py-3.5 rounded-xl sm:rounded-full font-bold flex items-center justify-center gap-2 active:scale-95 transition-all shadow-lg shadow-primary/20 disabled:opacity-70"
              >
            ...
            {error && (
              <div className="mt-4 flex items-center gap-2 text-red-500 font-medium text-sm animate-in fade-in slide-in-from-top-2">
